...
#import "ZXHandleLogViewController.h"
#import "SVProgressHUD.h"
#import "AFNetworking.h"
#import "NSObject+SBJson.h"
#import "HandleLogCell.h"

@implementation ZXHandleLogViewController
...
- (void)getLogList{
    ...
    NSString *URLString = [NSString stringWithFormat:@"%@/json2/handle.php?act=list&uid=%ld",
                           API_DOMAIN,uid];
    ...
    [manager POST:URLString parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        logArray = [resultDict objectForKey:@"hanleinfo"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *CellIdentifier = @"handleLogCell";
    HandleLogCell *cell = (HandleLogCell*)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[HandleLogCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
